...
namespace PlaceholderSoftware.WetStuff
{
        ...
        : BaseSerializedObjectFoldoutSection
    {
        ...
        {
            [SerializeField] [UsedImplicitly] public readonly Vector2 LayerMaskScale;
            [SerializeField] [UsedImplicitly] public readonly Vector2 LayerMaskOffset;

            [SerializeField] [UsedImplicitly] public readonly Channel Channel1;
            [SerializeField] [UsedImplicitly] public readonly Channel Channel2;
            [SerializeField] [UsedImplicitly] public readonly Channel Channel3;
            [SerializeField] [UsedImplicitly] public readonly Channel Channel4;

            public CopyPasteData(Vector2? layerMaskScale, Vector2? layerMaskOffset, Channel ch1, Channel ch2, Channel ch3, Channel ch4)
            {
                LayerMaskScale = layerMaskScale ?? new Vector2(1, 1);
                LayerMaskOffset = layerMaskOffset ?? new Vector2(0, 0);
            ...
            {
                [SerializeField] [UsedImplicitly] private readonly int _mode;
                ...
                [SerializeField] [UsedImplicitly] public readonly float InputThreshold;
                [SerializeField] [UsedImplicitly] public readonly float InputSoftness;
                [SerializeField] [UsedImplicitly] public readonly Vector2 OutputRange;
